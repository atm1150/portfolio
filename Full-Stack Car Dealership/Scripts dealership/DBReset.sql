...
BEGIN
	...
	DBCC CHECKIDENT ('Purchase', RESEED, 3)
	...
	VALUES	('John', 'Doe', '00000000-0000-0000-0000-000000000000', 0, 0, 'test@test.com',  0, 0, 0, 'test'),
			('Jane', 'Doe', '11111111-1111-1111-1111-111111111111', 0, 0, 'test2@test.com', 0, 0, 0, 'test2');
	...
	INSERT INTO Transmission(TransmissionID, TransStyle)
	VALUES (1,'Automatic'),
	(2,'Manual')
	...
	VALUES (1, 'Free Ipad', 'Buy a used car and get a free Ipad!', '11111111-1111-1111-1111-111111111111'),
	(2, 'Tire Rotation', 'Bring your car for service today! Rotation only $99.99 for used cars!', '11111111-1111-1111-1111-111111111111'),
	(3, 'Free Oil Change', 'Purchase a new vehicle and get one year of oil changes for free!', '11111111-1111-1111-1111-111111111111')
	...
	VehicleDescription, VehicleType, ImageFileName, BodyStyleID, TransmissionID, BodyColorID, InteriorColorID, IsAvailable, IsFeatured)
	VALUES (1, 2009, 1, 2, 14000, 21000, '1KKUKKE30AR251408',15000,
	 'Buy it today!', 'Used', 'redcar.jpg', 2, 2, 2, 1, 0, 0),
	(2, 2010, 2, 9, 14500, 22000, '1GKUBBE30AR251222',15500,
	 'This is too good to be true!', 'Used', 'yellowcar.jpg', 3, 1, 3, 1, 0, 1),
	(3, 2008, 1, 1, 13000, 20000, '1GKUKKE30AR251404',14000,
	...
	VALUES (1,'Cash', 20000.00, 1, '11111111-1111-1111-1111-111111111111', 2),
